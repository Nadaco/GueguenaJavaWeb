...
<form method="post" action="<%= application.getContextPath()%>/do/modifallnotesetudiant">
    <table border="1">
        <tr>
            <th>Etudiant</th>
            <th>Groupe</th>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="moyennes%>" value="<%=etudiant.getMoyenne()%>"/>
            </td>
        </tr>
        <input type="hidden" name="ids" value="<%=etudiant.getId()%>"/>
        <% } %>
    </table>
    <input type="submit" value="Modifier les notes"></input>
</form>
</body>
<footer>
